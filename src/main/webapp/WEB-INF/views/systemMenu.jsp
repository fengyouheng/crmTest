...
<body>
	...
	<div id="systemMenu_datagrid_tb">
		<div>
			<a class="easyui-linkbutton" disabled="true" iconCls="icon-add" plain="true" data-cmd="add">新增</a>
			<a class="easyui-linkbutton" disabled="true" iconCls="icon-edit" plain="true" data-cmd="edit">編輯</a>
			<a class="easyui-linkbutton" disabled="true" iconCls="icon-remove" plain="true" data-cmd="del">刪除</a>
			<a class="easyui-linkbutton" disabled="true" iconCls="icon-reload" plain="true" data-cmd="reload">刷新</a>
		</div>
	</div>
	<!-- 对话框保存取消按钮 -->
	...
	<div id="systemMenu_menuTree_tt">
		<a class="icon-remove" data-cmd="menutreedelete"></a>
		<a class="icon-reload" data-cmd="menutreereload"></a>
	</div>
</body>
</html>